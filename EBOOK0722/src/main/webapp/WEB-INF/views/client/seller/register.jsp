...
<body>
	...
	<form:form modelAttribute="seller" action="register"
		...
		<table>
			...
			<tr>
				<td>아이디</td>
				<td><form:input path="s_id" /><input type="button"
					id="overlappedID" value="중복검사"><span id="id_olmessage">
				</span></td>
				<td><font color="red"><form:errors path="s_id" /></font></td>
			</tr>
			...
			<tr>
				...
				<td><font color="red"><form:errors path="s_name" /></font></td>
			</tr>

			<tr>
				<td>주민번호</td>
				<td><input type="text" maxlength="6" id="rn1">&nbsp;-&nbsp;<input
					type="password" size="1" maxlength="1" id="rn2">●●●●●● <form:input
						path="s_resident_num" type="hidden" /></td>
				<td><font color="red"><form:errors path="s_resident_num" /></font></td>
			</tr>
