...
<h2>
	<spring:message code="notice.header.member.modify" />
</h2>
<form:form modelAttribute="notice" action="memberModify"
	...
	<table border="1">
		...
		<tr>
			...
			<td colspan="3"><form:input path="mn_title" size="80" /></td>
		</tr>
		<tr>
...
<script>
	$(document).ready(function() {
		...
		$("#btnList").on("click", function() {
			self.location = "/notice/memberList${pgrq.toUriString()}";
		});
	});
</script>