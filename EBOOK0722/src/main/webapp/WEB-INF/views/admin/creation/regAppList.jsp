...
<h2>
	<spring:message code="creation.header.registerApp" />
</h2>
...
<table border="1">
	...
	<c:choose>
		<c:when test="${empty regAppList }">
			<tr>
				<td colspan="9"><spring:message code="common.listEmpty" /></td>
			</tr>
		</c:when>
		<c:otherwise>
			<c:forEach items="${regAppList }" var="creationlist">
				<tr>
					...
					<td align="left"><a href="regInfo?e_num=${creationlist.e_num}">${creationlist.e_title }</a></td>
					<td align="center"><img
