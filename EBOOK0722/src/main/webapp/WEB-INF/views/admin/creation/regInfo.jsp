...
<form:form modelAttribute="creation" action="regApproval">
	...
	<table border="1">
		...
		<tr>
			...
			<td align="center" width="200">DOWNLOAD</td>
		</tr>
	</table>
</form:form>
<br />
<div>
	<button type="submit" id="btnApproval"
		...
		<spring:message code="action.regapproval" />
	</button>
	<button type="submit" id="btnRefuse"
		style="background-color: green; padding: 12px; font-size: 16px; border: none;">
		<spring:message code="action.regrefuse" />
	</button>
</div>
...
<script>
	$(document).ready(function() {
		...
		$("#btnRefuse").on("click", function() {
			...
			self.location = "/creation/regRefuse?e_num=" + e_numVal;
		});
	});
</script>