...
<h2>
	<spring:message code="creation.header.deleteApp" />
</h2>
<table border="1">
	<tr>
		...
		<th align="center" width="160"><spring:message code="creation.eno" /></th>
		<th align="center" width="80"><spring:message
	...
	<c:choose>
		<c:when test="${empty delAppList }">
			<tr>
				<td colspan="9"><spring:message code="common.listEmpty" /></td>
			</tr>
		</c:when>
		<c:otherwise>
			<c:forEach items="${delAppList }" var="creationlist">
				<tr>
					...
					<td align="left"><a href="delInfo?e_num=${creationlist.e_num}">${creationlist.e_title }</a></td>
					<td align="center"><img
