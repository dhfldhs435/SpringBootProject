...
public class SellerController {
	...
	public String register(@Validated Seller seller, Errors errors, RedirectAttributes rttr) throws Exception {
	...
	@PreAuthorize("hasRole('ROLE_SELLER')")
	public String modifyForm(Integer s_num, Model model) throws Exception {
	...
	@PreAuthorize("hasRole('ROLE_SELLER')")
	public String modify(@Validated Seller seller) throws Exception {
