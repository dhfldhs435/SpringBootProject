...
public class Seller {
	...
	// message = "영문,숫자,특수기호가 적어도1개 이상씩 포함된 8~20자의 문자 조합을 입력해주세요.")
	private String s_pw; // 판매자 회원 비밀번호

	// @NotBlank(message = "닉네임은 필수 입력 값입니다.")
	// @Pattern(regexp = "^[a-zA-z가-힣0-9_-]{2,10}$")
	...
	// @Pattern(regexp =
	// "^(?:[0-9]{2}(?:0[1-9]|1[0-2])(?:0[1-9]|[1,2][0-9]|3[0,1]))[1-4]{1}$")
	...
	// @Pattern(regexp = "^[A-Za-z0-9가-힣\s()-]{1,}")
	...
	private String s_seller_agree; // 판매 약관 동의 여부
	private String s_content_agree; // 컨텐츠등록 약관 동의 여부
	private String s_privaty_agree; // 개인정보 이용 약관 동의 여부
