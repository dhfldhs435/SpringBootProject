...
public class NoticeServiceImpl implements NoticeService {
	...
	// 판매자회원 공지사항 목록 페이지
	@Override
	public List<Notice> sellerlist(PageRequest pageRequest) throws Exception {
		return mapper.sellerlist(pageRequest);
	}
	...
	// 일반회원 공지사항 목록 페이지
	@Override
	public List<Notice> memberlist(PageRequest pageRequest) throws Exception {
		return mapper.memberlist(pageRequest);
	}
